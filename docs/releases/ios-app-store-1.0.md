...
최신 실행 증거와 수정 내역은 [2026-09-05 점검](release-audit-2026-09-05.md)을 참고한다. 읽기 전용 사전 점검은 `npm --prefix apps/web run native:check:store`로 실행한다. 자동 통과도 실기기·운영·심사 승인을 대신하지 않는다.
